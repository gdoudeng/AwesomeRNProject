...
import {
  ...
  Animated,
  Dimensions,
  BackHandler, BackPressEventName
} from "react-native";
...
// event types
const HARDWARE_BACK_PRESS_EVENT: BackPressEventName = "hardwareBackPress";
...
class Dialog extends Component<DialogProps, State> {
  ...
  onHardwareBackPress = (): boolean | undefined => this.props.onHardwareBackPress?.();
